...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $query_transaksi = "INSERT INTO transaksi (ID_TRANSAKSI, EMAIL, TOTAL_BAYAR, METODE_PEMBAYARAN) 
                        VALUES ('$id_transaksi', '$email', '$total_bayar', '$metode_pembayaran')";
    ...
    if (mysqli_query($kon, $query_transaksi)) {
        ...
        echo json_encode(array('status' => 'failed', 'message' => 'Gagal simpan transaksi: ' . mysqli_error($kon)));
    }
}
mysqli_close($kon);
?>